$(document).ready(function(){
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //                   if(id != ''){
    //                     // var idd = $id->strCastingID;
    //                     arrID = id.split("");
    //                      for(var ctr = arrID.length - 1; ctr >= 0; ctr--)
    //                      {
    //                        nnew = arrID[ctr];
    //                        if(boolAdd)
    //                        {
    //                          if($.isNumeric(nnew) || nnew == '0')
    //                          {
    //                           // alert('numeric!');
    //                            if(nnew == '9')
    //                            {
    ...
    //                      for(var ctr2 = 0; ctr2 < arrID.length; ctr2++)
    //                      {
    //                        // alert('ctr2: '+ arrNew[ctr2]);
    ...
    //                 }
    //                 else{
    //                   //kunin muna latest sa datatable then increment
    //                   var tbldata = table.column(tblrows).data();
    //                   var str = JSON.stringify(tbldata);
    //                   alert('tbldata: '+ str);
    //                 }
